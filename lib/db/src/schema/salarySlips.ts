import { pgTable, serial, varchar, date, numeric, timestamp, integer } from "drizzle-orm/pg-core";
...
export const insertSalarySlipSchema = createInsertSchema(salarySlipsTable).omit({ id: true, createdAt: true, updatedAt: true });
